...
">
            <div>
                <h1 className="text-6xl md:text-6xl lg:text-[3.5rem] xl:text-[6rem] text-[#CDE82B] font-titan tracking-wide text-center mb-5 z-[1000] text-stroke">
                    Hello, <br />
                    <span className="text-8xl md:text-9xl lg:text-[9rem] xl:text-[10rem] lg:leading-[100%] xl:leading-[100%]">World!</span>
                </h1>
            </div>
