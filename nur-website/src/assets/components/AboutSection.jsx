  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start lg:w-1/2 mx-12 lg:pl-24 ">
        ...
        >
          <span className="text-md font-medium font-['Roboto'] text-black">More about me</span>
      ...
      <img
        src={GalataTower}
        alt="About Image"
        className=" lg:w-auto lg:h-[80vh] w-full h-auto object-contain mt-4 lg:mt-8 data-twe-lazy-load-init"
      />
    </section>
  );
};
