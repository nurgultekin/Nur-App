  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start lg:w-1/2 mx-12 lg:pl-24 ">
        ...
        <ul className="list-disc pl-5 text-whitesmoke p-6 max-w-lg space-y-4 text-md md:text-lg">
          <li>
        ...
        <a 
          href="/AboutPage"
          className="secondary-button transition flex justify-center items-center gap-2"
        >
