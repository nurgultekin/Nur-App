...
">
            ...
            <div className="w-full max-w-lg sm:max-w-xl lg:max-w-3xl">
                <p className="text-white text-[1rem] md:text-[1rem] lg:text-[1.2rem] mx-auto md:ml-12 text-shadow font-semibold text-lg md:text-xl leading-[130%] font-roboto text-left">
