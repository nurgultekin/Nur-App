    ...
    <section className="other" id="custom-height">
      ...
      <Slider {...settings}>
        <div className="project-card">
          <img src={pipelineImage} alt="Pipeline" style={{ height: '20dvh', width: 'auto' }} />
        ...
        <div className="project-card">
          <img src={masterWorkflowImage} alt="Master Workflow" style={{ height: '20dvh', width: 'auto' }} />
        ...
        <div className="project-card">
          <img src={redditImage} alt="Reddit" style={{ height: '20dvh', width: 'auto' }} />
