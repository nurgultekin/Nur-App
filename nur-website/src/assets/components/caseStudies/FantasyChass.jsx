    ...
    <div className="min-h-screen flex flex-col justify-between">
      <AnimationDark/>
        ...
        <div className="text-white flex flex-col justify-center items-left lg:items-left mt-10 md:mt-10 lg:mt-48 max-w-[70vw] lg:max-w-[40vw] gap-4 mx-auto">
          <div className=" font-titan text-[18px] sm:text-[18px] sm:leading-normal md:text-[24px] md:leading-[28px] lg:text-[32px] lg:leading-[36px]">Case Study 4: </div>
          <div className=" font-titan text-[42px] sm:text-[42px] sm:leading-normal md:text-[60px] md:leading-[64px] lg:text-[78px] lg:leading-[80px] ">Fantasy Chass</div>
